<x-app-layout>
    <form method="post" action="">
        ...
        <div x-data="testalpine">
            ...
            <div>
                <template x-for="plate in plates">
                <pre x-text="JSON.stringify(plates)"></pre>
                </template>
            </div>
            ...
            <div x-show="printing_price > 0 || buyframe_price > 0 || fixing_price > 0" class="p-3 flex flex-col items-center bg-white">
                <div class="p-3 flex flex-col items-center">
                    <div class="w-80 flex justify-between items-center text-center">
                        <div>
                            <div>{{ __('Printing') }}:</div>
                            <span class="text-xs font-bold"> R.O</span>
        ...
        document.addEventListener("alpine:init", () => {
            ...
            Alpine.data("testalpine", () => ({
                ...
                selectPlateType(type) {
                    ...
                    this.price_collected_by_rop = this.checkMoneyCollection(type);
                },
                ...
                resetValues() {
                    ...
                    this.extra_price = 0;
                    this.total_price = 0;
                    this.price_collected_by_rop = false;
                },
                ...
                checkMoneyCollection(plateType) {
                    return ['government', 'specific', 'private', 'commercial', 'learner', 'temporary', 'export'].filter(item => item == plateType).length > 0
                },
